                    ...
                    <div className="col-xl-12">
                      ...
                      <center>
                        <FeedbackRadioButtons
                          className="feedbackRadioButtons"
                          ...
                          name="did_you_find_what_you_needed"
                          onChange={(did_you_find_what_you_needed) =>
                            setFormData({
                              ...formData,
                        ...
                        <FeedbackRadioButtons
                          ...
                          options={["Yes", "No"]}
                          name="Is_this_the_first_time_you_have_visited_the_website"
                          onChange={(
                      ...
                      <button
                        type="submit"
                        className="btn"
                        style={{ backgroundColor: "#ff6d12", color: "white" }}
                      >
                        Send Message
                      </button>
                    </div>
            ...
            <div class="col-xl-4 d-flex align-items-stretch">
              <div class="contact-page__info-box">
                <div class="contact-page__info-box-address">
                  ...
                  <p class="contact-page__info-box-address-text">
                    IIIT Sri City <br /> Andhra Pradesh, India
                  </p>
                </div>
