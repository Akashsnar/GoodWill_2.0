...
function UserdetailsForm(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(' http://localhost:4000/userinfo', formData);
                ...
                <div className="bg-gray-100 mx-auto max-w-6xl bg-white py-20 px-12 lg:px-24 shadow-xl mb-24">
                    <form className="space-y-5" onSubmit={handleSubmit} role='Loginpage'>
                        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                            ...
                            <button draggable={true} onDragStart={(e) => e.dataTransfer.setData('text', imagePreview)}>
                                <label htmlFor="dropzone-file" className="flex w-full flex-col ">
                                    <div className="flex flex-col items-center justify-center">
                                        <p className="text-sm dark:text-gray-400"><span className="font-semibold">Upload your Picture</span> </p>
                                    </div>
                                    <input id="dropzone-file" type="file" className="m-auto" name='image' onChange={(e) => _handleImageChange(e)} />
                                </label>
                                <div className="imgPreview">
                                    {imagePreview ? <img src={imagePreview} className="w-[15rem] h-[15rem] m-auto mt-10 border-2 rounded-full" /> : <div className="previewText pt-3">Please select an Image for Preview</div>}
                                </div>
                            </button>
                            ...
                            <div className="-mx-3 md:flex mb-6">
                                <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="company" name='name' type="text" placeholder="Name" value={formData.name} onChange={handleChange} />
                                    {/* <div>
